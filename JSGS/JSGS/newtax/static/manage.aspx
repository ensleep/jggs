<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manage.aspx.cs" Inherits="JSGS.newtax.static.manage" %>
        ...
        <div id="main">
            ...
            <form runat="server" id="form1">
                <div style="background-color:white;width:913px;height:424px;">
                    ...
                    <div style="overflow:visible"><div style="text-align:left;padding-left:40px;margin-top:-14px">当前位置：<span style="color:gray">首页</span>&gt;&gt;网上办税平台</div></div>
                    <div style="background-color:white">
                        <div style="float:left;width:225px;background-image:url('/Images/menubarnoword.png');background-repeat:no-repeat">
                            ...
                            <div style="margin-left:38px;font-size:14px">
                                <div style="height:32px;color:gray">更换所属时期</div>
                                <div style="height:32px;color:gray">网上申报说明</div>
                                <div style="height:32px;color:gray">常见问题解答</div>
                                <div style="height:32px;color:gray">封面汇总打印</div>
                                <div style="height:32px;color:gray">退出网上申报</div>
                            </div>
                        </div>
                        <div style="float:left;width:635px">

                            <div style="color:gray;line-height:23px;font-size:13px;height:23px;vertical-align:middle">
                                <div style="float:left;width:25px;"><img src="../../Images/curror.png" height="23px" alt="" /></div>
                                <div style="float:left;">你现在的位置：[企业]...申报报表...选择所属时期页面</div>
                                <div style="clear:both"></div>
                            </div>
                            <div style="height:10px"></div>
                            <div style="background-image:url('/Images/managebg.png');background-repeat:repeat;height:577px;width:635px">
                                fsadfsdfsdfsddddddddddddddddddddddddddddddddd
                            </div>
                        </div>
                        <div style="clear:both"></div>
                    </div>
