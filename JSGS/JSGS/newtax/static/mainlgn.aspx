<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mainlgn.aspx.cs" Inherits="JSGS.newtax.static.mainlgn" %>
    ...
    <div id="center">
     ...
     function(){
        ...
        <div id="main">
            ...
            <form name="f" action="/newtax/static/j_spring_security_check" method="POST">
                ...
                <div>
                    ...
                    <div id="right" style="text-align: left; background-image: url('/Images/UserInfo.png'); width: 277px; height: 202px">
                        ...
                        <div style="padding-left: 17px">
                            <div style="text-align: left; height: 25px">欢迎您：南京汉风堂能源物资有限公司</div>
                            <div style="text-align: left; height: 25px">纳税人识别号：320103671319696</div>
                            <div style="text-align: left; height: 25px">纳税人名称：南京汉风堂能源物资有限公司</div>
                            <div style="color: gray; text-align: left; height: 25px">纳税人权限管理界面</div>
                            <div style="color: gray; text-align: left; height: 25px">修改用户信息</div>
                            <div style="color: gray; text-align: left; height: 25px">安全退出</div>
                        </div>
                    </div>
                </div>
                <div id="leftbott">
